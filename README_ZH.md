...
| [gate-dex-mcpmarket](https://github.com/gate/gate-skills/tree/master/skills/gate-dex-mcpmarket) | Gate 钱包 DEX 市场数据：K 线、交易统计、流动性、代币信息、排名、安全审计、新代币发现 | ✅ 活跃 |
| [gate-dex-mcpwallet](https://github.com/gate/gate-skills/tree/master/skills/gate-dex-mcpwallet) | Gate 钱包资产组合与交易历史：余额、总资产、代币持仓、转账/Swap 历史 | ✅ 活跃 |
| [gate-dex-mcpswap](https://github.com/gate/gate-skills/tree/master/skills/gate-dex-mcpswap) | Gate 钱包 Swap/DEX 交易：获取报价、跨 EVM 和 Solana 执行 Swap | ✅ 活跃 |
| [gate-dex-mcptransfer](https://github.com/gate/gate-skills/tree/master/skills/gate-dex-mcptransfer) | Gate 钱包转账执行：跨 EVM 和 Solana 的原生代币及 Token 转账 | ✅ 活跃 |
| [gate-dex-mcpdapp](https://github.com/gate/gate-skills/tree/master/skills/gate-dex-mcpdapp) | Gate 钱包 DApp 交互：连接钱包、签名消息、执行 DApp 交易、ERC20 Approve | ✅ 活跃 |
| [gate-dex-mcpauth](https://github.com/gate/gate-skills/tree/master/skills/gate-dex-mcpauth) | Gate 钱包认证：Google OAuth 登录、会话管理 | ✅ 活跃 |
| [gate-mcp-cursorinstaller](https://github.com/gate/gate-skills/tree/master/skills/gate-mcp-cursorinstaller) | 一键安装 Gate MCP 和 Skills（适用于 Cursor） | ✅ 活跃 |
| [gate-mcp-openclawinstaller](https://github.com/gate/gate-skills/tree/master/skills/gate-mcp-openclawinstaller) | Gate.com MCP 服务器完整安装器（适用于 OpenClaw） | ✅ 活跃 |
...
- Node.js & npm
- 支持 MCP 的 AI 智能体（Cursor、OpenClaw 等）

### 一键安装

通过安装器技能，几秒钟即可开始：

**Cursor 用户** — 使用 `gate-mcp-cursorinstaller` 一键安装所有 Gate MCP 服务器和技能：
...
**OpenClaw 用户** — 使用 `gate-mcp-openclawinstaller` 完成 Gate MCP 完整设置，支持交互式选择：
